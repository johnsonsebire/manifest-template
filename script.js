document.addEventListener('DOMContentLoaded', () => {
    // ========================
    // Secondary Header Scroll Behavior
    // ========================
    
    const secondaryHeader = document.querySelector('.secondary-header');
    let lastScrollTop = 0;
    let isScrollingUp = false;
    const scrollThreshold = 200; // Show secondary header after scrolling 200px
    ...
    window.addEventListener('scroll', () => {
        ...
        // Show secondary header when scrolling up and past threshold
        if (isScrollingUp && scrollTop > scrollThreshold) {
            if (secondaryHeader) {
    ...
    // Make secondary header mobile toggle work with existing mobile nav
    const secondaryMobileToggle = document.querySelector('.secondary-header .mobile-menu-toggle');
    if (secondaryMobileToggle) {
        secondaryMobileToggle.addEventListener('click', () => {
            const mobileNav = document.querySelector('.mobile-nav');
            const mobileOverlay = document.querySelector('.mobile-nav-overlay');
            const primaryToggle = document.querySelector('.primary-header .mobile-menu-toggle');
            
            // Toggle active states
            secondaryMobileToggle.classList.toggle('active');
            if (primaryToggle) primaryToggle.classList.toggle('active');
